...
TPL_MARKETS = 'http://api.zb.cn/data/v1/markets'
TPL_ALL_MARKET = 'http://api.zb.cn/data/v1/allTicker'
TPL_MARKET = 'http://api.zb.cn/data/v1/ticker?market={MARKET}'
TPL_DEPTH = 'http://api.zb.cn/data/v1/depth?market={MARKET}&size={SIZE}'
TPL_TRADES = 'http://api.zb.cn/data/v1/trades?market={MARKET}'
TPL_KLINE = 'http://api.zb.cn/data/v1/kline?market={MARKET}'

URL_ORDER = 'https://trade.zb.cn/api/order'
URL_CANCEL_ORDER = 'https://trade.zb.cn/api/cancelOrder'
URL_GET_ORDER = 'https://trade.zb.cn/api/getOrder'
URL_GET_ORDERS = 'https://trade.zb.cn/api/getOrders'
URL_GET_ORDERS_NEW = 'https://trade.zb.cn/api/getOrdersNew'
URL_GET_ORDERS_IGNORE_TRADE_TYPE = 'https://trade.zb.cn/api/getOrdersIgnoreTradeType'
URL_GET_UNFINISHED_ORDERS_IGNORE_TRADE_TYPE = 'https://trade.zb.cn/api/getUnfinishedOrdersIgnoreTradeType'
URL_GET_ACCOUNT_INFO = 'https://trade.zb.cn/api/getAccountInfo'
URL_GET_USER_ADDRESS = 'https://trade.zb.cn/api/getUserAddress'
URL_GET_WITHDRAW_ADDRESS = 'https://trade.zb.cn/api/getWithdrawAddress'
URL_GET_WITHDRAW_RECORD = 'https://trade.zb.cn/api/getWithdrawRecord'
URL_GET_CHARGE_RECORD = 'https://trade.zb.cn/api/getChargeRecord'
URL_WITHDRAW = 'https://trade.zb.cn/api/withdraw'
